(function() {
  ...
  function k(b, c) {
    ...
    function R(a, b) {
      f.captions[a] && 1 == f.captions[a][b].enable
    }
    var G = {
    ...
    this.enableButtons = function(a) {
      !0 !== a || f.buttons || (d("#" + b + " .ism-button").remove(), T())
    };
  ...
  e.crossFade = function(b, c, d, e) {
    ...
    var r = +new Date,
      u, m = function() {
        ...
        r = +new Date;
        0 < h ? window.requestAnimationFrame && requestAnimationFrame(m) : (b.style.opacity = 0, c.style.opacity = 1, b.style.filter = "", c.style.filter = "", e && e())
      };
    m()
  };
